...
# Revision: $Id: Helper.pm,v 1.10 2005/08/10 17:27:31 sashby Exp $ 
#
...
sub version()
   ...
   $help.="\n";
   $help.="The -i option shows CVS commit info (the value of '\$Id: Helper.pm,v 1.10 2005/08/10 17:27:31 sashby Exp $').\n";
